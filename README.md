...
- **Authentication**: Secure server-side login with 2 hardcoded users (admin/password1, user/password2) using cookies for session management
...
git clone https://github.com/TechLEarners2000/2D-to-3D-Image-Converter.git
